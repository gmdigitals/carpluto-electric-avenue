...
-- Create a new table for non-boolean admin settings
...
-- Enable RLS on admin_text_settings
ALTER TABLE public.admin_text_settings ENABLE ROW LEVEL SECURITY;

-- Create policies for admin_text_settings
...
CREATE TRIGGER update_admin_text_settings_updated_at
BEFORE UPDATE ON public.admin_text_settings
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

-- Insert watermark URL setting
INSERT INTO admin_text_settings (setting_key, setting_value, description) VALUES 
